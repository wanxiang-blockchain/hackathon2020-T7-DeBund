package com.blockchain4life.ipfs.multibase;


import com.blockchain4life.ipfs.multibase.binary.Base32;
import com.blockchain4life.ipfs.multibase.binary.Base64;
...
public class Multibase {
    ...
    public static String encode(Base b, byte[] data) {
        switch (b) {
            ...
            case Base64:
                return b.prefix + com.blockchain4life.ipfs.multibase.binary.Base64.encodeBase64String(data).replaceAll("=", "");
            case Base64Pad:
                return b.prefix + com.blockchain4life.ipfs.multibase.binary.Base64.encodeBase64String(data);
            default:
