<template>
  <view class="index">
    <AtNoticebar marquee>
      您的合同文件已存储至IPFS,MultiHash值：QmQCTz1jiHFiv6UHCvAzPuNpuk6RVQR1PM8X3VHAHtA3FX
    </AtNoticebar>
    ...
    <view class="loginMain">
      ...
      <view class="codeBox">
        <image :src="stepCode" class="codeImg"></image>
      </view>
    ...
    <view class="loginEnd">
      <AtMessage />
      <view @tap="this.handleClick" class="btn">回到首页</view>
    </view>
  ...
  data () {
    return {
      ...
      items3:[
        ...
        { title: '支付租金', desc: '支付完成点击我已支付',status: 'success'},
